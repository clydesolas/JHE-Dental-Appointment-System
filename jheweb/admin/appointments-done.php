        ...
        <div class='dashboard-content'>
            <div class='container'>
                <div class='card'>
                    ...
                    <a type="button" href="appointments-approved.php" class="btn btn-secondary text-nowrap text-decoration-none">Approved</a>
                    ...
                    <button type="button" href="appointments-done.php" class="btn btn-secondary text-decoration-none text-nowrap"disabled>Done</button>
                    ...
                    <thead class="text-white" style="background-color:#305f82;">
                                ...
                                <tbody >
                                  ...
                                  <?php 
                                  $sqll = mysqli_query($con,"SELECT * FROM appointment where `status`= 'Done'")or die(mysqli_error($con));
                                  while($row = mysqli_fetch_array($sqll)){

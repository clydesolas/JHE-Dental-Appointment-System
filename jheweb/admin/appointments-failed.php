        ...
        <div class='dashboard-content'>
            <div class='container'>
                <div class='card'>
                    ...
                    <a type="button" href="appointments-approved.php" class="btn btn-secondary text-decoration-none text-nowrap">Approved</a>
                    <a type="button" href="appointments-declined.php"class="btn btn-secondary rounded-0 text-nowrap text-decoration-none">Declined</a>
                    <a type="button" href="appointments-done.php" class="btn btn-secondary text-decoration-none text-nowrap">Done</a>
                    <button type="button" href="appointments-failed.php"class="btn btn-secondary rounded-0 text-decoration-none text-nowrap "disabled>Failed</button>
                    </div>
                    </div>
                    ...
                    <thead class="text-white" style="background-color:#305f82;">
                                ...
                                <tbody >
                                  ...
                                  <?php 
                                  $sqll = mysqli_query($con,"SELECT * FROM appointment where `status`= 'Failed'")or die(mysqli_error($con));
                                  while($row = mysqli_fetch_array($sqll)){
                                   ...
                                   <td>
                                   <a rel="tooltip"  title="View Info" id="<?php echo $appointment_id; ?>"href="#statusView<?php echo $appointment_id; ?>" data-bs-toggle="modal" class="btn btn-info"><i class="bi bi-info-circle"></i></a>
                                   <?php include('modal_appointment-viewStatus.php'); ?>
                                       <a rel="tooltip"  title="Delete" id="<?php echo $appointment_id; ?>"href="#delete<?php echo $appointment_id; ?>" data-bs-toggle="modal" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                                   </td>
                                   
                                   <?php include('modal_appointment-delete.php'); ?>

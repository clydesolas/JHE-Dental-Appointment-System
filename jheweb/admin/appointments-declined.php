        ...
        <div class='dashboard-content'>
            <div class='container'>
                <div class='card'>
                    ...
                    <button type="button" href="appointments-declined.php"class="btn btn-secondary rounded-0 text-nowrap"disabled>Declined</button>
                    ...
                    <thead class="text-white" style="background-color:#305f82;">
                                ...
                                <tbody >
                                  ...
                                  <?php 
                                  $sqll = mysqli_query($con,"SELECT * FROM appointment where `status`= 'Declined'")or die(mysqli_error($con));
                                  while($row = mysqli_fetch_array($sqll)){
                                    ...
                                    <td>
                                    <a rel="tooltip"  title="View Appointment" id="<?php echo $appointment_id; ?>" href="#declinedView<?php echo $appointment_id; ?>" data-bs-toggle="modal" >View</a> 
                                    <?php include('modal_appointment-decline.php'); ?>
                                    </td>

                 <!-- modal -->             
                 <div class="modal" id="approvedView<?php echo $appointment_id; ?>"data-bs-backdrop="static">
                 <div class="modal-dialog" >
            <div class="modal-content rounded-4 shadow">
            <div class="modal-header border-bottom-0">
                <h5 class="modal-title"><b>View Approved Appointment</b> </h5>
            ...
            <div class="modal-body">
                ...
                <table class="table table-bordered" style=" width:100%">
                    ...
                    <tr>
                        <th>Remark: </th>
                        <td> <textarea class="form-control" name="input_remark" placeholder="Write a remark.."required><?php echo $row['remark'] ;?></textarea></td>
                    </tr>
						</table>
                </div>

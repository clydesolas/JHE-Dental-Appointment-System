...
<div class="alert alert-warning"><h3 style="text-align:center">Password reset link expired.</h3>    </div>
    ...
    <div class="col  d-flex justify-content-center">
                <a href="index.php"class="w-30 btn btn-light" href="index.php" >Go back to HOME PAGE</a>
            </div>
    </form>

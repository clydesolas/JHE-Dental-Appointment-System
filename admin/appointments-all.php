            ...
            <div class='container'>
                <div class='card'>
                    ...
                    <div class="btn-group flex-wrap" role="group" >
                        <button type="button" href="appointments-all.php"class="btn btn-secondary rounded-0 text-decoration-none mx-1 text-nowrap"disabled >All</button>
                    ...
                    <thead class="text-white" style="background-color:#305f82;">
                                ...
                                <tbody >
                                  ...
                                  <?php 
                                  $sqll = mysqli_query($con,"SELECT * FROM appointment")or die(mysqli_error($con));
                                  while($row = mysqli_fetch_array($sqll)){

...
//   $accesstoken="ALUMNI";
  ...
  if(!$problem){
    ...
    $link = "<a href='https://jhedentalclinic.online/verify-email.php?key=".$_POST['email']."&token=".$token."'> Click and Verify Email</a>";
    $mail = new PHPMailer();
    $mail->CharSet =  "utf-8";
    $mail->IsSMTP();
    ...
    $mail->SMTPAuth = true;                  
    // GMAIL username
    $mail->Username = "info@jhedentalclinic.online";
    // GMAIL password
    $mail->Password = "o1=ek4-zXr";
    $mail->SMTPSecure = 'tls';
    // sets GMAIL as the SMTP server
    $mail->Host = "sg2plzcpnl458811.prod.sin2.secureserver.net";
    // set the SMTP port for the GMAIL server
    $mail->Port = "465";
    $mail->From='info@jhedentalclinic.online';
    $mail->FromName='J.H.E. DENTAL';
    $mail->AddAddress($email, $fname.' '.$lname);
    $mail->Subject  =  'Verify Your Account';
    $mail->IsHTML(true);
    $mail->Body    = '<H3>Hello '.$fname.', <br>Please Click On This Link to Verify Your Email <br><center><b style="background-color:green">'.$link.' </b></center></H3>';
    if($mail->Send())
    {
